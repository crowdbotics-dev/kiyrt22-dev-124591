...
class BgrconnectorViewSet(BaseConnectorViewSet):
    PASSWORD = settings.BGR_CONNECTOR_PASSWORD
    USERNAME = settings.BGR_CONNECTOR_USERNAME
    BASE_URL = "https://devstringx.com"
    AUTH_TYPE = "basic"
    IDENTIFIER = "BGR_CONNECTOR"
